...
//         </div>
//         {/* Add/Edit Modal */}
//         <Modal isOpen={showAddForm || editingItem} onClose={() => { setShowAddForm(false); setEditingItem(null); }}>
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        ...
        setMenu(mappedMenu);
        // const normalized = menuData.map(item=>({
        //   ...item,
  ...
  const handleAddItem = async (e) => {
    ...
    try {
      ...
      const formatted = {
        ...
        price: added.price,
        isVeg: added.isVegetarian};

      //added.isVeg = added.isVegetarian;
